...
${KUBECTL} annotate xbackups.aws.caas.upbound.io --all crossplane.io/paused="true" --overwrite=true
${KUBECTL} delete release -l crossplane.io/claim-name=backup-test
